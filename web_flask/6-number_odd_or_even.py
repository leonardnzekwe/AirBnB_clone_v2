...
# Define a route to display an HTML page with "Number: n" if n is an integer
...
# Define a route to display an HTML page
# with "Number: n is even|odd" if n is an integer
